...
export default function SubjectPage({ params }: { params: { subjectId: string } }) {
 ...
 {sub.id === "ai" && (
 <Link
 href="/important-questions/ai-pyq-match"
 className="mt-4 flex items-center justify-between gap-4 bg-white border border-slate-200 rounded-2xl p-5 hover:shadow-lift hover:-translate-y-0.5 transition"
 >
 <div>
 <p className="font-mono text-[11px] font-semibold uppercase tracking-[.14em] text-ink-mute">School paper · matched</p>
 <h2 className="font-bold text-[17px] mt-1">Which school-paper questions are in the 50 solved</h2>
 <p className="text-[13px] text-ink-soft mt-1">The 2025-26 paper matched question by question with the 50 solved list - and the topics that are not in the 50.</p>
 </div>
 <span className="flex items-center gap-1 text-[13px] font-bold text-brand-600 shrink-0">Open <Icon name="arrowUpRight" size={15} /></span>
 </Link>
 )}
