    ...
    <div ref={rootRef} className="sb-root" data-layout="split">
      <header className="sb-top">
        ...
        <div className="sb-group">
          <button className="sb-btn" id="btnOpen" title="PDF / DOCX / TXT / Image kholo"><Icon name="folder" size={17} /> Open</button>
        ...
        <div className="sb-group" id="layoutGroup" title="Layout">
          <button className="sb-btn" data-layout="doc" title="Sirf document (1)"><Icon name="fileText" size={17} /> Doc</button>
          <button className="sb-btn on" data-layout="split" title="Doc + Board side by side (2)"><Icon name="columns2" size={17} /> Split</button>
          <button className="sb-btn" data-layout="board" title="Sirf whiteboard (3)"><Icon name="presentation" size={17} /> Board</button>
        </div>
        <div className="sb-group">
        ...
        <div className="sb-group">
          ...
          <button className="sb-btn" id="btnSave" title="Session save (auto-save on)"><Icon name="save" size={17} /> Save</button>
          ...
          <a className="sb-btn" href="/" title="Wapas Learning Hub"><Icon name="home" size={17} /></a>
        </div>
      </header>
      ...
      <div className="sb-main">
        <aside className="sb-rail" id="rail">
          ...
          {tool("pan", "hand", "PAN", "Pan / Haath (H)")}
          <div className="rail-sep" />
          {tool("pen", "pencil", "PEN", "Pen (P)")}
          {tool("highlighter", "highlighter", "HIGH", "Highlighter (M)")}
          {tool("eraser", "eraser", "ERASE", "Eraser — tap object to delete (E)")}
          <div className="rail-sep" />
          ...
          <button className="tool" id="toolClear" title="Is page/board ko saaf karo"><Icon name="trash2" size={21} /><small>CLEAR</small></button>
        </aside>
        ...
        <div className="sb-work">
          ...
          <div id="divider" title="Khisak kar size badlo"><span className="grip" /></div>
      ...
      <div className="modal" id="mText"><div className="modal-card">
        <h2><Icon name="type" size={22} /> Text likho</h2><p>Board/PDF par jahan likhna hai wahan pehle tap karo, phir yahan likho.</p>
      ...
      <div className="modal" id="mSticky"><div className="modal-card">
        <h2><Icon name="stickyNote" size={22} /> Sticky note</h2><p>Important point, homework ya reminder — rang chuno.</p>
        <textarea id="stickyInput" placeholder="Note likho…" />
        <label>Rang</label>
        <div className="swatches" id="stickyColors" style={{ marginTop: 6 }} />
        <div className="mrow"><button className="mbtn" data-close="1">Cancel</button><button className="mbtn primary" id="stickyOk"><Icon name="check" size={17} /> Chipkao</button></div>
      </div></div>
      ...
      <div className="modal" id="mGraph"><div className="modal-card" style={{ maxWidth: 640 }}>
        ...
        <div className="mrow"><button className="mbtn" data-close="1">Band karo</button><button className="mbtn primary" id="graphToBoard"><Icon name="pin" size={17} /> Board par bhejo</button></div>
      </div></div>

      <div className="modal" id="mClass"><div className="modal-card">
        <h2><Icon name="timer" size={22} /> Class Tools</h2><p>Timer, random student picker, attendance — sab ek jagah.</p>
        ...
        <div id="paneAtt" style={{ display: "none" }}>
          <div className="mrow" style={{ marginTop: 0 }}><button className="mbtn" id="attAll"><Icon name="check" size={17} /> Sab present</button><button className="mbtn" id="attNone">Reset</button></div>
      ...
      <div className="modal" id="mExport"><div className="modal-card">
        <h2><Icon name="download" size={22} /> Export / Share</h2><p>Board ka kaam save rakho ya print karo.</p>
        <div className="mrow"><button className="mbtn primary" id="exBoardPng"><Icon name="image" size={17} /> Board → PNG image</button><button className="mbtn" id="exPagePng"><Icon name="fileText" size={17} /> Is PDF page → PNG</button></div>
        <div className="mrow"><button className="mbtn" id="exJson"><Icon name="save" size={17} /> Session download (JSON)</button><button className="mbtn" id="exImportBtn"><Icon name="upload" size={17} /> Session kholo (JSON)</button><input type="file" id="exImport" accept=".json" hidden /></div>
        <div className="mrow"><button className="mbtn" id="exPrint"><Icon name="printer" size={17} /> Print</button><button className="mbtn danger" id="exWipe"><Icon name="trash2" size={17} /> Sab kuch delete</button></div>
        <div className="mrow"><button className="mbtn" data-close="1">Band karo</button></div>
      </div></div>

      <div className="modal" id="mHelp"><div className="modal-card">
        <h2><Icon name="circleHelp" size={22} /> Smart Board Guide</h2>
        <div className="grid gap-2.5 text-[14px]" style={{ display: "grid", gap: 10, fontSize: 14 }}>
          <p><b>Open</b> se PDF / DOCX / Image kholo ya drag-drop karo</p>
          <p><b>Split</b> me ek side PDF, ek side board — divider khisak kar size badlo</p>
          <p>Pen / Highlighter se likho • <b>Shapes</b> me line, arrow, circle, star, tick</p>
          <p><b>Maths</b> button: symbols + graph plotter</p>
          <p>Sab <b>auto-save</b> hota hai — kal wapas kholo to milega</p>
        </div>
        ...
        <div className="mrow"><button className="mbtn primary" data-close="1"><Icon name="check" size={17} /> Samajh gaya</button></div>
      </div></div>
