...
const input = "w-full bg-white border border-slate-300 rounded-xl px-3.5 py-2.5 text-sm outline-none focus:border-slate-900 transition";
...
export default function AdminPanel() {
 ...
 <label className="grid gap-1.5 text-[12px] font-bold text-ink-mute mb-2.5">
 SUBJECT
 ...
 <label className="grid gap-1.5 text-[12px] font-bold text-ink-mute ">
 CHAPTER
 ...
 {chapterDetail(key)
 ? <span className="flex items-center gap-2 text-[12.5px] font-bold px-3 py-2 rounded-xl bg-slate-900 text-white "><Icon name="star" size={15} /> Built-in content</span>
 : <span className="flex items-center gap-2 text-[12.5px] font-bold px-3 py-2 rounded-xl bg-amber-50 text-amber-800 border border-amber-200 "><Icon name="info" size={15} /> Auto-guide mode</span>}
 {getLocalOverride(key) && <span className="flex items-center gap-2 text-[12.5px] font-bold px-3 py-2 rounded-xl bg-brand-50 text-brand-700 "><Icon name="penLine" size={15} /> Teacher override active</span>}
 <span className={`flex items-center gap-2 text-[12.5px] font-bold px-3 py-2 rounded-xl ${isFirebaseConfigured ? "text-white" : "bg-slate-100 text-ink-mute "}`} style={isFirebaseConfigured ? { background: "#1a73e8" } : undefined}>
 ...
 {msg && <div className="flex items-center gap-2 text-sm font-semibold bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2.5 mb-3"><Icon name="checkCircle" size={17} className="text-g-green flex-none" /> {msg}</div>}
 ...
 <div key={i} className="rounded-2xl border border-slate-200 bg-slate-50/60 p-4 space-y-2">
 ...
 <button onClick={() => patch({ slides: [...(detail.slides || []), { ...blankSlide, points: [""] }] })} className="flex items-center justify-center gap-2 w-full rounded-2xl border-2 border-dashed border-slate-300 font-bold text-sm py-3 hover:bg-slate-50 transition">
 ...
 {tab === "notes" && (
 <div>
 <p className="text-[12.5px] text-ink-mute mb-1.5 flex items-center gap-1.5"><Icon name="info" size={14} /> Each line = one note point. <b>&lt;b&gt;bold&lt;/b&gt;</b> HTML works.</p>
 ...
 <div className="space-y-3">
 {(detail.quiz || []).map((q, i) => (
 <div key={i} className="rounded-2xl border border-slate-200 bg-slate-50/60 p-4 space-y-2.5">
 ...
 {tab === "pyq" && (
 <div>
 <p className="text-[12.5px] text-ink-mute mb-1.5">Each line = one PYQ.</p>
