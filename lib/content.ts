...
"science-0-0": {
  ...
  mindmap: { central: "⚗️ Chemical Reactions",
    branches: [
      ...
      { label: "⚠️ Effects", color: "#e11d48", children: ["Corrosion (zang)", "Rancidity (tel kharab)", "Galvanisation", "Antioxidants + N₂"] },
    ]},
  flowchart: [
    { title: "👀 Observe karo", desc: "Rang? Gas? Garmi? Precipitate? = reaction hui" },
    { title: "✍️ Word Equation likho", desc: "Magnesium + Oxygen → Magnesium oxide" },
    { title: "🧪 Formula (Skeleton) likho", desc: "Mg + O₂ → MgO" },
    { title: "⚖️ Balance karo", desc: "2Mg + O₂ → 2MgO — atoms barabar?" },
    { title: "🏷️ Type pehchano", desc: "Combination? Displacement? Redox?", type: "decision" },
...
"sst-0-1": {
  slides: [
    { kicker: "History Ch.2 • Nationalism in India", title: "🇮🇳 भारत में राष्ट्रवाद (1915–1947)",
      ...
      formula: "Satyagraha = Satya + Ahimsa ✌️" },
    { kicker: "1915–1919", title: "Shuruaat: 3 Chhote Satyagraha",
      ...
      formula: "13 April 1919 — Jallianwala Bagh 🕯️" },
    ...
    { kicker: "Sense of Belonging", title: "Rाष्ट्रवाद कैसे फैला? ❤️",
  ...
  mindmap: { central: "🇮🇳 Nationalism in India",
    branches: [
      { label: "✌️ Satyagraha", color: "#2563eb", children: ["Champaran 1916", "Kheda 1917", "Ahmedabad 1918", "Rowlatt 1919"] },
...
"english-0-0": {
  slides: [
    { kicker: "Prose 1 • G.L. Fuentes", title: "✉️ A Letter to God",
    ...
    { kicker: "Story 2", title: "Toofan aur Barbaadi ⛈️",
  ...
  mindmap: { central: "✉️ A Letter to God",
    branches: [
      ...
      { label: "✍️ Devices", color: "#7c3aed", children: ["Irony (ending)", "Personification (rain-coins)", "Metaphor (locusts-hail)", "Symbolism (letter)"] },
    ]},
  flowchart: [
    { title: "🌧️ Aasha", desc: "Baarish aayi — Lencho khush, 'naye sikke!'" },
    { title: "⛈️ Musibat", desc: "Ole (hailstorm) — poori fasal barbaad" },
    { title: "✉️ Chitthi", desc: "God ko 100 pesos ki chitthi likhi" },
